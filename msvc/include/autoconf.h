 ...
 */
#define AUTOCONF_TIMESTAMP "2015-11-27 12:35:30 CET"
...
#define ENABLE_GLOBBING 0
#define IF_GLOBBING(...)
#define IF_NOT_GLOBBING(...) __VA_ARGS__
#undef CONFIG_SAFE_ENV
#define ENABLE_SAFE_ENV 0
#define IF_SAFE_ENV(...)
#define IF_NOT_SAFE_ENV(...) __VA_ARGS__
